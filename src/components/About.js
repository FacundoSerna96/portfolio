...
import cvFoto from "../assets/Cv con foto .pdf";
...
function About() {
  ...
  return (
    <div
      ref={ref}
      className={isVisible ? "about-component about-visible" : "about-component"}
      id="about"
    >
      <div className="photo">
      ...
      <div className="about-body">
        <span className="section-label">
          {language ? "01 — Quién soy" : "01 — Who I am"}
        </span>
        <h2>Facundo Serna</h2>
        ...
        <div className="buttonsContact">
          ...
          >
            ...
            {language ? <p>CV (Formato Harvard)</p> : <p>Download Resume</p>}
          </button>

          {language && (
            <button
              className="button-cv"
              onClick={() => window.open(cvFoto, "_blank")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="15"
